<template>
  <div class="max-w-2xl mx-auto p-6">
    <form
      ...
      class="space-y-6 bg-white dark:bg-noir text-noir dark:text-light rounded-lg shadow-lg p-6 dark:shadow-secondary"
    >
...
<div v-if="activity === 'cloud'" class="space-y-4">
  ...
  <div>
    ...
    <select v-model="instance" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-noir text-noir dark:text-light">
  ...
  <div>
    ...
    <select v-model="storageType" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-noir text-noir dark:text-light">
